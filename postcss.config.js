...
OpenProps["--seam-radius"] = "0.5rem";
OpenProps["--seam-button-primary"] =
  "linear-gradient(to bottom, rgb(96 165 250), rgb(59 130 246))";
OpenProps["--seam-button-primary--hover"] =
  "linear-gradient(to bottom, rgb(59 130 246), rgb(37 99 235))";
OpenProps["--seam-button-primary--active"] =
  "linear-gradient(to bottom, rgb(147 197 253), rgb(96 165 250))";
