...
function seamButton({ loading, success, fail, variant, spacing, href, target, download }: Props<typeof seamButton>) {
    ...
    return (
        <host shadowDom>
            {variant == "link" ?
                (<a part="base" href={href} target={target} download={download} onclick={() => clickDispatch()} class={classNames("button", {
